...
connection = pika.BlockingConnection(
    pika.ConnectionParameters(credentials=pika.credentials.PlainCredentials(args.username, args.password), host='172.28.93.135', heartbeat=600, blocked_connection_timeout=500))
