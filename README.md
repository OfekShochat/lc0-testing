...
2. add a worker user with the credentials username: worker, password: weDoWorkHere
3. for "production", you would need to change all "localhost" in files to your host. 
4. wait for me to finish serve.py